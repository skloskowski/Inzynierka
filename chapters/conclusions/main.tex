...
zdjęć na ostrość obrazu wynikowego. Wizualna porównanie wykorzystania algorytmów sugerują nieznaczne zmiany w jakości obrazu wynikowego na korzyść algorytmów złożonych (Kappa-Sigma Clipping oraz 
Auto Adaptive Weighted Average) dla jednej godziny całkowitego czasu integracji fotografii. 
...
na poziom sygnału do szumu w obrazie wynikowym korzystając z obiektywnych metod pomiaru SNR w obrazach obiektów głębokiego nieba.
...
W przyszłości planuje się rozszerzenie analizy o dokładne pomiary SNR, badanie zużycia pamięci przez poszczególne algorytmy oraz wpływu parametrów dla algorytmu Kappa-Sigma Clipping oraz 
wpływu parametrów oraz wykorzystanej funkcji ważenia dla algorytmu Auto Adaptive Weighted Average na czas działania programu oraz jakość obrazu wynikowego korzystając z bardziej zaawansowanych technik badawczych.
...
Do rozszerzenia funkcjonalności aplikacji można rozważyć implementacja dodatkowych metod nakładania zdjęć i możliwość dostosowania parametrów algorytmów przez użytkownika oraz rozszerzenia procesu rejestracji zdjęć o 
