...
Zestaw 1499 wykorzystywał zdjęcia o czasie naświetlania 60 sekund w porównaniu do zestawu 244, który wykorzystywał zdjęcia o czasie naświetlania 120 sekund.
...
Przed obliczeniem ostatecznych wyników zdecydowano się na odrzucenie błędów grubych, które zdefiniowano na czasy odbiegające znacznie od średniego czasu działania dla badanej kombinacji.
...
wartości czasu działania dla tej kombinacji - po odrzuceniu tego błędu grubego odchylenie standardowe pomiarów wyniosło poniżej 1 sekundy.
...
użyto klatki kalibracyjne. Każda z fotografii wynikowych została zmodyfikowano w ten sam sposób (w zakresie pojedynczego zestawu) w celu poprawy widoczności szczegółów na zdjęciach - zastosowano krzywe tonalne oraz zwiększono nasycenie kolorów.
Krzywa tonalna to narzędzie do edycji zdjęć pozwalające na nieliniową zmianę jasności pikseli na zdjęciu. W kontekście astrofotografii zastosowanie krzywych tonalnych pozwala na
wydobycie słabo widocznych szczegółów poprzez zwiększenie kontrakstu w ciemniejszych obszarach zdjęcia bez prześwietlenia jaśniejszych obszarów zdjęcia. Zmiana nasycenia kolorów
to proces polegający na zmianie składowej barwy pikseli przy jednoczesnym zachowaniu ich składowej luminacji (jasności). Zwiększenie nasycenia kolorów na zdjęciach pozwala na uwydatnienie
kolorów obiektów astronomicznych zwiększając kontrast pomiędzy strukturami mgławic a tłem nieba.
...
Ze względu na różne warunki obserwacyjne, jasność nieba w zenicie, niespójną edycję pomiędzy zestawami oraz różny czas naświetlania pojedynczego zdjęcia, fotografie wynikowe nie powinny zostać porównywane pomiędzy zestawami.
...
Na rysunkach \ref{fig:zestaw244_noise_kappa_comp} i \ref{fig:zestaw1499_noise_kappa_comp} przedstawiono wizualne porównanie tych samych wycinków zdjęć wynikowych dla różnych czasów integracji zdjęć. Obrazy wynikowe zostały wykonane korzystając z algorytmu Kappa-Sigma Clipping.
...
fotografie wynikowe nie powinny zostać porównywane pomiędzy zestawami. Na zmodyfikowanych fotografiach gwiazdy mają identyczną jasność. Poziom jasności całego zdjęcia różni się jednak 
w zależności od czasu integracji z powodu ilości szumu. Tło, które zawiera szum wygląda niejednolicie i zawiera kolorowe ziarna - w idealnych warunkach tło powinno być jednolite i czarne.
