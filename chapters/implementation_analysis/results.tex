...
\begin{figure}[!ht]
    ...
    \caption{Porównanie na wykresie średnich czasów nakładania zdjęć w zależności od metody nakładania zdjęć i czasu integracji dla zestawów 244}
...
\bottomrule
\end{tabular}
\caption{Porównanie w tabeli średnich czasów nakładania zdjęć w zależności od metody nakładania zdjęć i czasu integracji dla zestawów 244.}\
...
\begin{figure}[!ht]
    ...
    \caption{Porównanie na wykresie średnich czasów nakładania zdjęć w zależności od metody nakładania zdjęć i czasu integracji dla zestawów 1499}
...
\bottomrule
\end{tabular}
\caption{Porównanie w tabeli średnich czasów nakładania zdjęć w zależności od metody nakładania zdjęć i czasu integracji dla zestawów 1499.}
