...
rzeczywistych danych astronomicznych. Proces wykonania danych testowych oraz opis zestawów został przedstawiony w rozdziale \ref{chapter:data_acquisition}.
...
zestawu 1499 z całkowitym czasem naświetlania 10 minut: jeden bez wykonanych klatek kalibracyjnych a drugi wraz z pełnym zestawem klatek kalibracyjnych. Nastepnie, dla obu zestawów wykonano pełny przebieg
...
Obraz został zbadany wizualnie w celu wykrycia ewentualnych artefaktów lub błędów w przetwarzaniu. Nie stwierdzono widocznych problemów z jakością obrazu poza artefaktami związanymi z
...
obraz przedstawiono na rysunku \ref{fig:california_edited}. Obraz został poddany obróbce w celu przetestowania danych w ekstremalnych warunkach. Obraz został edytowany przy użyciu programuów
...
wskazuje na wysoki stosunek sygnału do szumu.  Widoczne są również szczegóły struktury NGC1499 i mgławic otaczających gwiazdę Atik przedstawionej w prawym górnym rogu obrazu.
...
Podczas wykonywania testów manualnych zauważono, że zaimplementowany interfejs konsolowy jest praktyczny do automatyzacji procesu przetwarzania zdjęć, ułatwiając wykonywanie powtarzalnych zadań.
Jednakże, dla użytkowników początkujących może stanowić barierę wejścia ze względu na wymóg korzystania z linii komend. W przyszłości należy rozważyć implementację graficznego interfejsu użytkownika,
ułatwiającego korzystanie z aplikacji szerszemu gronu użytkowników. Ze względu na modularną architekturę aplikacji, implementacja GUI może współistnieć z istniejącym interfejsem konsolowym
udostępniająć użytkownikom wybór preferowanego sposobu interakcji z programem.
