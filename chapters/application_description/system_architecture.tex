...
\begin{figure}[!ht]
    ...
    \caption{Główny przebieg działania programu.}
    \label{fig:mainflow}
\end{figure}

Na rysunku \ref{fig:mainflow} przedstawiono główny przebieg działania programu. W celu realizacji zadań systemu oraz umożliwienia przyszłego rozwoju zdecydowano się na podział na odpowiednie,
...
wynikających z nieprawidłowej organizacji danych.
