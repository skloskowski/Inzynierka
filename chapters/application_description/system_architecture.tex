...
Na rysunku \ref{fig:mainflow} przedstawiono główny zarys działania programu. W celu realizacji zadań systemu oraz umożliwienia przyszłego rozwoju zdecydowano się na podział systemu na odpowiednie,
niezależne od siebie, moduły. System składa się z modułu inicjalizacji, modułu przetwarzania fotografii, modułu rejestracji, modułu kalibracji, modułu nakładania zdjęć, 
modułu interakcji z plikami i modułu sterującego zawierającego elementy interakcji z użytkownikiem. 
